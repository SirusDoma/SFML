...
class GlRenderTarget : public sf::GlRenderTarget
{
public:
...
TEST_CASE("[Graphics] sf::GlRenderTarget")
{
    SECTION("Type traits")
    {
        STATIC_CHECK(!std::is_constructible_v<sf::GlRenderTarget>);
        STATIC_CHECK(!std::is_copy_constructible_v<sf::GlRenderTarget>);
        STATIC_CHECK(!std::is_copy_assignable_v<sf::GlRenderTarget>);
        STATIC_CHECK(!std::is_nothrow_move_constructible_v<sf::GlRenderTarget>);
        STATIC_CHECK(std::is_nothrow_move_assignable_v<sf::GlRenderTarget>);
    }
