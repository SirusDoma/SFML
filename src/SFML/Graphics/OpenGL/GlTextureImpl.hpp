...
///
////////////////////////////////////////////////////////////
class GlTextureImpl : public TextureImpl, GlResource
{
public:
    ////////////////////////////////////////////////////////////
    ...
    ///
    ////////////////////////////////////////////////////////////
    GlTextureImpl() = default;

    ////////////////////////////////////////////////////////////
    /// \brief Destructor
    ///
    ////////////////////////////////////////////////////////////
    ~GlTextureImpl() override;
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Bind a texture and its texture matrix for rendering
    ///
    /// This is the OpenGL backing of `sf::Texture::bind`, it also
    /// sets up the texture matrix required for pixel coordinates,
    /// padded sizes and flipped pixels.
    ///
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Get the maximum texture size allowed by the driver
    ///
...
private:
    ...
    // Member data
    ////////////////////////////////////////////////////////////
    unsigned int m_texture{}; //!< Internal OpenGL texture identifier
};
