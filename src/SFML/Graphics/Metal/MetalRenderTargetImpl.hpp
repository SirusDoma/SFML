...
{
////////////////////////////////////////////////////////////
/// \brief Metal implementation of the render target pipeline
///
////////////////////////////////////////////////////////////
class MetalRenderTargetImpl : public RenderTargetImpl
{
public:
    ////////////////////////////////////////////////////////////
    /// \brief Constructor
    ...
    ///
    ////////////////////////////////////////////////////////////
    explicit MetalRenderTargetImpl(MetalGraphicsDevice& device);
...
private:
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Draw primitives from the currently bound vertex source
    ///
    ////////////////////////////////////////////////////////////
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Set the pending matrices from the current matrix state
    ///
    ////////////////////////////////////////////////////////////
    ...
    // Member data
    ////////////////////////////////////////////////////////////
    MetalGraphicsDevice& m_device; //!< Device this render target renders through
    ...
    bool m_lastColorWrite{true}; //!< Color write state of the current blend mode
};
