...
////////////////////////////////////////////////////////////
void GlRenderTarget::clearStencil(StencilValue stencilValue)
{
    if (isActive(m_id) || setActive(true))
    {
        // Unbind texture to fix RenderTexture preventing clear
...
////////////////////////////////////////////////////////////
void GlRenderTarget::clear(Color color, StencilValue stencilValue)
{
    if (isActive(m_id) || setActive(true))
    {
        // Unbind texture to fix RenderTexture preventing clear
...
////////////////////////////////////////////////////////////
void GlRenderTarget::setView(const View& view)
{
...
////////////////////////////////////////////////////////////
void GlRenderTarget::draw(const Drawable& drawable, const RenderStates& states)
{
...
////////////////////////////////////////////////////////////
void GlRenderTarget::draw(const Vertex* vertices, std::size_t vertexCount, PrimitiveType type, const RenderStates& states)
{
    // Nothing to draw?
...
////////////////////////////////////////////////////////////
void GlRenderTarget::draw(const VertexBuffer& vertexBuffer, const RenderStates& states)
{
...
////////////////////////////////////////////////////////////
void GlRenderTarget::draw(const VertexBuffer& vertexBuffer, std::size_t firstVertex, std::size_t vertexCount, const RenderStates& states)
{
...
////////////////////////////////////////////////////////////
bool GlRenderTarget::setActive(bool active)
{
...
////////////////////////////////////////////////////////////
void GlRenderTarget::pushGLStates()
{
    if (isActive(m_id) || setActive(true))
    {
#ifdef SFML_DEBUG
...
////////////////////////////////////////////////////////////
void GlRenderTarget::popGLStates()
{
    if (isActive(m_id) || setActive(true))
    {
        glCheck(glMatrixMode(GL_PROJECTION));
...
////////////////////////////////////////////////////////////
void GlRenderTarget::resetGLStates()
{
...
{
    // Initialize the base class (sets up views)
...
////////////////////////////////////////////////////////////
void GlRenderTarget::applyCurrentView()
{
    // Set the viewport
    const IntRect viewport    = getViewport(getView());
    ...
    if (getView().getScissor() == FloatRect({0, 0}, {1, 1}))
    {
    ...
    {
        const IntRect pixelScissor = getScissor(getView());
...
////////////////////////////////////////////////////////////
void GlRenderTarget::applyBlendMode(const BlendMode& mode)
{
...
////////////////////////////////////////////////////////////
void GlRenderTarget::applyStencilMode(const StencilMode& mode)
{
...
////////////////////////////////////////////////////////////
void GlRenderTarget::applyTransform(const Transform& transform)
{
...
////////////////////////////////////////////////////////////
void GlRenderTarget::applyTexture(const Texture* texture, CoordinateType coordinateType)
{
...
////////////////////////////////////////////////////////////
void GlRenderTarget::applyShader(const Shader* shader)
{
    Shader::bind(shader);
}
...
////////////////////////////////////////////////////////////
void GlRenderTarget::setupDraw(bool useVertexCache, const RenderStates& states)
{
...
////////////////////////////////////////////////////////////
void GlRenderTarget::drawPrimitives(PrimitiveType type, std::size_t firstVertex, std::size_t vertexCount)
{
...
////////////////////////////////////////////////////////////
void GlRenderTarget::cleanupDraw(const RenderStates& states)
{
