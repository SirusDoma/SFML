...
////////////////////////////////////////////////////////////
/// \brief Vulkan implementation of the render target pipeline
///
////////////////////////////////////////////////////////////
class VulkanRenderTargetImpl : public RenderTargetImpl
{
public:
    ////////////////////////////////////////////////////////////
    /// \brief Constructor
    ...
    ///
    ////////////////////////////////////////////////////////////
    explicit VulkanRenderTargetImpl(VulkanGraphicsDevice& device);
...
private:
    ...
    ///
    /// \return `true` when the draw can be submitted, `false` when
    ///         the shader could not be bound and it has to be dropped
    ///
    ////////////////////////////////////////////////////////////
    [[nodiscard]] bool applyShader(const Shader* shader);
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Clear attachments of the open pass inside a rectangle
    ///
    /// Backing of the scissored clears: Vulkan clears rectangles
    /// natively with a clear-attachments command inside the pass.
    ///
    /// \param target       Render target being cleared
    /// \param aspects      Aspects to clear
    /// \param color        Fill color for the color aspect
    /// \param stencilValue Stencil value for the stencil aspect
    ///
    ////////////////////////////////////////////////////////////
    void clearRect(RenderTarget& target, VkImageAspectFlags aspects, Color color, StencilValue stencilValue);

    ////////////////////////////////////////////////////////////
    // Member data
    ////////////////////////////////////////////////////////////
    VulkanGraphicsDevice& m_device; //!< Device this render target renders through
    ...
    bool m_lastColorWrite{true}; //!< Color write state of the currently pending blend state
};
