...
{
////////////////////////////////////////////////////////////
/// \brief Direct3D 11 implementation of the texture
///
////////////////////////////////////////////////////////////
class D3D11TextureImpl : public TextureImpl
{
public:
    ////////////////////////////////////////////////////////////
    /// \brief Constructor
    ...
    ///
    ////////////////////////////////////////////////////////////
    explicit D3D11TextureImpl(D3D11GraphicsDevice& device);
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Get the backend texture object, used by the render pipeline
    ///
    /// \return Pointer to the texture, null if creation failed
    ///
    ////////////////////////////////////////////////////////////
    ...
    ///
    /// \return Pointer to the view, null if creation failed
    ///
    ////////////////////////////////////////////////////////////
...
private:
    ...
    // Member data
    ////////////////////////////////////////////////////////////
    D3D11GraphicsDevice&             m_device;             //!< Graphics device the texture lives on
    ComPtr<ID3D11Texture2D>          m_texture;            //!< Backend texture object
    ComPtr<ID3D11ShaderResourceView> m_shaderResourceView; //!< View used to sample the texture
};
